...
- A file `MUST` contain two functions: intervalConstruction() and intervalIdentification() [as defined here](predefined-files). You may add any other functionality to the file.
